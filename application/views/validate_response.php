                    ...
                    <tbody>
                       ...
                       <?php if(isset($validation['valid_json'])) : ?>
                        ...
                        <?php if(!empty($dataset_count)) : ?>
                            <tr>
                                <th>Total records</th> <td><?php echo $dataset_count; ?></td>
                            </tr>
                        <?php endif; ?>                       
                ...
                if(!empty($validation['errors'])) {
                    ...
                    foreach ($validation['errors'] as $key => $error) {                      
                        ...
                        if ($source_key === "catalog") {
                            $source_output = $validation['catalog'];
                        } elseif (!is_array($validation['source'])) {
                            $source_output = $validation['source'];
                        } else {
                            $source_output = $validation['source'][$source_key];
                        }
                    ...
                    <div class="validation-record row">
                        ...
                        <div class="validation-source col-md-6">
                            ...
                            <pre><code><?php print htmlentities(prettyPrint(str_replace('\/', '/', json_encode($source_output)))); ?></code></pre>
                        </div>
